...
_proxy = {'http': '127.0.0.1:7897', 'https': '127.0.0.1:7897'}
# 生产不需要代理
_proxy = {}
class Client:
    ...
    def __init__(self, key=None, client_id=None, client_secret=None,
                 ...
                 requests_session=None, proxies=_proxy,
    ...
    def _request(self, url, params, first_request_time=None, retry_counter=0,
                 base_url=None, accepts_clientid=True, proxies=_proxy,
